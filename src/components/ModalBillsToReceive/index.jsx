...
export const ModalBillsToReceive = (props) => {
    ...
    const {accounts, getAccounts, setShowModalBillsToReceive, getBillsToReceive} = useContext(TransactionContext);
    ...
    const updateBillsToReceive = async () => {
        await api.updateBillsToReceive(id, account, valueField, dateField, tStatus);
        setShowModalBillsToReceive(false)
        getBillsToReceive()
    }
        ...
        <div className="modalBillsToReceive">
            <div className='modalArea'>
                ...
                <div className='actionButtons'>
                    ...
                    <span className='pay' onClick={updateBillsToReceive}>Receber</span>
                </div>
            </div>
        </div>
    )
